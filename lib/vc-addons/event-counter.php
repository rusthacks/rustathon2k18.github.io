    ...
    $output .= '<div class="shortcode-event-countdown '.esc_attr($class).'" style="'. $align .'">';
		...
		$output .= '<div class="counter-class" data-date="'.$countdate.'">';
			$output .= '<div id="countdown-timer">';
				$output .= '<div class="countdown-section"><span class="countdown-amount first-item countdown-days counter-days"></span> <span class="countdown-period">'.esc_html__( 'Days', 'eventum' ).'</span></div>';
				$output .= '<div class="countdown-section"><span class="countdown-amount countdown-hours counter-hours"></span> <span class="countdown-period">'.esc_html__( 'Hours', 'eventum' ).'</span></div>';
				$output .= '<div class="countdown-section"><span class="countdown-amount countdown-minutes counter-minutes"></span> <span class="countdown-period">'.esc_html__( 'Minutes', 'eventum' ).'</span></div>';
				$output .= '<div class="countdown-section"><span class="countdown-amount countdown-seconds counter-seconds"></span> <span class="countdown-period">'.esc_html__( 'Seconds', 'eventum' ).'</span></div>';
			$output .= '</div>';
		$output .= '</div>';
