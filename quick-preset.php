...
if(isset($themeum_options['custom-preset-en']) && $themeum_options['custom-preset-en']) {
	...
	if(isset($link_color)){
		...
		.Gym-Button-Light:hover a.btn-white,.tp-caption.Gym-Button-Light:hover a.btn-white,#navigation .woocommerce ul.cart_list li a,#main-menu .nav>li>a:hover,#main-menu .nav>li>a:hover,ul.latest-review h3.entry-title a:hover,#main-menu .nav>li.active.current>a,.sp-speaker .speaker-title a:hover{ color: '. esc_attr($link_color) .'; }';
